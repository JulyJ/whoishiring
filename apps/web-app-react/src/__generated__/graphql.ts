...
export type GetNewJobPostsCountQueryVariables = Exact<{
  lastFetchedTimestamp: Scalars['UnixTimestamp']['input'];
  filter?: InputMaybe<JobPostingFilter>;
}>;


export type GetNewJobPostsCountQuery = { __typename?: 'Query', newJobCount: { __typename?: 'NewJobCount', count: number } };
...
export const GetNewJobPostsCountDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetNewJobPostsCount"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"lastFetchedTimestamp"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UnixTimestamp"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"filter"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"JobPostingFilter"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"newJobCount"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"lastFetchedTimestamp"},"value":{"kind":"Variable","name":{"kind":"Name","value":"lastFetchedTimestamp"}}},{"kind":"Argument","name":{"kind":"Name","value":"filter"},"value":{"kind":"Variable","name":{"kind":"Name","value":"filter"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"count"}}]}}]}}]} as unknown as DocumentNode<GetNewJobPostsCountQuery, GetNewJobPostsCountQueryVariables>;